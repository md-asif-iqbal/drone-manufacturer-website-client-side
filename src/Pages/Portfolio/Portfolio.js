...
import img from'../image/portfolio-img.avif'
import asif from '../image/asif-pic.JPEG'
const Portfolio = () => {
    return (
        <div class="font-sans h- antialiased text-gray-900 leading-normal tracking-wider max-h-full bg-cover" style={{ backgroundImage: `url(${img})`}}>
	...
	<div class="w-full lg:w-2/5 lg:h-96 ">

		<img src={asif} class="rounded-none lg:rounded-lg shadow-2xl hidden lg:block"/>
