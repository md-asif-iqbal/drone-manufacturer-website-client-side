            ...
            <div className="w-1/3 bg-cover bg-landscape ml-5">
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="custom-number-input h-10 w-full">
                                <label className="w-full text-gray-700 text-sm font-semibold">TOTAL PRICE = {prices? prices : 0}</label> 
                    ...
                    <div className="form-control w-full max-w-xs relative z-0 group">
                        <label className="label">
                            <span className="label-text">What's your current Address?</span>
                        </label>
                        <input
                            type="text"
