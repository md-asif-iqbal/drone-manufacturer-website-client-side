...
const Purchase = () => {
 ...
 const validate = (value) => {
        ...
        console.log('Validating Email Here!' , value);
       }
    return (
        <div>
       <h1>hello:{id}</h1>
...
<div className="flex  bg-white shadow-lg rounded-lg">
    <div className="w-1/3 bg-cover bg-landscape ml-5">
        ...
        <p className='text-gray-600'>Minimum order:  <span className='text-yellow-400 font-bold'>{minimum}</span> piece</p>
        <p className='text-gray-600'>Stock : <span className='font-bold'>{stock} piece</span></p>
        <h1 className="text-gray-700 ">
                Price: <span className='font-bold text-xl'>${price} Per Piece</span> 
            </h1>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
            <div className="custom-number-input h-10 w-32 mb-10 ">
                        <label className="w-full text-gray-700 text-sm font-semibold">QUANTITY</label> 
            ...
            <div className="custom-number-input h-10 w-32 flex ">
                        <label className="w-full text-gray-700 text-sm font-semibold">TOTAL PRICE =</label> 
            ...
            <input className='btn w-full max-w-xs text-white' type="submit" value="Order Confirm" />
        </form>
    </div>
</div>
</div>
