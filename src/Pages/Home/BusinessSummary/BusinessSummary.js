...
const BusinessSummary = () => {
    ...
    <h1 className='text-cyan-400 text-4xl font-extrabold mt-10 mb-10 '>Our Business Summary</h1>
    <h1 className='text-teal-600 text-2xl tracking-widest font-bold mt-2 mb-2 '>Trusted by over 8000+ customers</h1>
         ...
         <div className="lg:stats md:stats sm:stats-horizontal shadow ">      
            <div className="stat">
                ...
                <div className="stat-value text-teal-600">100K</div>
            ...
            <div className="stat sm">
                ...
                <div className="stat-value text-teal-600">50+</div>
